        ...
        setContent {
            L2Theme {
                Surface(
                    ...
                    Labo2(cambios = viewModel2.cambios, contador = viewModel2.transitionedStatesCounter)
                }
            }
        }
    }
...
@Composable
fun Labo2(cambios: Int, contador: Map<AppLifecycleState, Int>,  modifier: Modifier = Modifier) {
    Column (
